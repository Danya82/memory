...
questions = [
    Question("лялька", "doll", "ball", "small", "big"),
    Question("сніговик", "snowman", "snowflag", "snow", "snowball"),
    Question("книга", "book", "food", "cook", "foot"),
    Question("кухня", "kitchen", "bedroom", "living room", "bathroom"),
    Question("рубашка", "shirt", "shorts", "skirt", "T-shirt")
]
shuffle(questions)
current_question = 0
